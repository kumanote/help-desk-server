...
use crate::entities::{InquiryContact, SearchResults, Task};
use crate::{Result, SearchClient};
use meilisearch_sdk::search::SearchQuery;

/// primary key for inquiry_contacts index
const PRIMARY_KEY: &'static str = "id";
const INDEX_NAME: &'static str = "inquiry_contacts";

pub async fn add_or_replace(client: &SearchClient, entity: InquiryContact) -> Result<Task> {
    client
        .index(INDEX_NAME)
...
pub async fn search(
    ...
    limit: usize,
    offset: usize,
) -> Result<SearchResults<InquiryContact>> {
